...
```
Time to set up:       npx @horizontal/ai-kit init (30 seconds)
Time to maintain:     npx @horizontal/ai-kit update (when stack changes)
...
|---|---|---|
| **What you type** | "Create a ProductCard component" | `/new-component ProductCard` |
| **What AI knows** | Nothing about your project | Your framework, styling, CMS, conventions |
...
| | Cost | Benefit |
|---|---|---|
| **Setup** | 30 seconds (`npx ai-kit init`) | AI understands your project forever |
| **Maintenance** | Occasional `ai-kit update` | Rules stay current with stack changes |
| **Learning curve** | Read getting-started.md (5 min) | 25 slash commands available immediately |
