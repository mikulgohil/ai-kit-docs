...
npx @horizontal/ai-kit init ./path/to/project
```
...
| `.claude/commands/*.md` | Claude Code selected |
...
npx @horizontal/ai-kit update ./path/to/project
```
...
npx @horizontal/ai-kit reset ./path/to/project
```
