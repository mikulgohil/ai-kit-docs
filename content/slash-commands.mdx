...
| `/review` | Quality & Review | Deep code review following Horizontal standards |
...
Deep code review following Horizontal Digital standards. Goes beyond linting — it evaluates structure, intent, and maintainability.
...
**What it checks**
- Code review against Horizontal standards
