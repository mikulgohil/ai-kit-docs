...
@api-designer Design the REST API for the orders resource
```
...
| `build-resolver` | Runs build command and diagnoses errors |
| `e2e-runner` | Analyzes test coverage and identifies gaps |
| `migration-specialist` | Audits dependency versions for upgrades |
