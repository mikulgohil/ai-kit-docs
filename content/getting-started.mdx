...
✓ 46 skills generated (Claude Code + Cursor)
✓ 46 legacy commands copied (.claude/commands/)
✓ 10 agents generated (.claude/agents/)
...
- Check [Skills & Commands](/docs/slash-commands) to see all 46 available workflows
- Learn about [Hooks](/docs/hooks) (including mistakes auto-capture), [Agents](/docs/agents), and [Context Modes](/docs/context-modes)
