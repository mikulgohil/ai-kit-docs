...
✓ 45 skills generated (Claude Code + Cursor)
✓ 45 legacy commands copied (.claude/commands/)
...
- Check [Skills & Commands](/docs/slash-commands) to see all 45 available workflows
