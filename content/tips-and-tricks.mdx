...
```bash
alias aik="npx @horizontal/ai-kit"
```
...
1. Clone the repo
2. Run `npx @horizontal/ai-kit init` (if not already committed)
...
cd packages/web && npx @horizontal/ai-kit init
cd packages/api && npx @horizontal/ai-kit init
```
